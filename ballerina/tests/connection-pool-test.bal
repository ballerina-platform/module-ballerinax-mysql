...
function testLocalSharedConnectionPoolConfigSingleDestination() returns error? {
    ...
    Client dbClient1 = check new (host, user, password, poolDB_1, port, options, pool);
    Client dbClient2 = check new (host, user, password, poolDB_1, port, options, pool);
    Client dbClient3 = check new (host, user, password, poolDB_1, port, options, pool);
    Client dbClient4 = check new (host, user, password, poolDB_1, port, options, pool);
    Client dbClient5 = check new (host, user, password, poolDB_1, port, options, pool);
...
function testLocalSharedConnectionPoolConfigDifferentDbOptions() returns error? {
    ...
    Client dbClient1 = check new (host, user, password, poolDB_1, port,
        {connectTimeout: 2, socketTimeout: 10}, pool);
    Client dbClient2 = check new (host, user, password, poolDB_1, port,
        {socketTimeout: 10, connectTimeout: 2}, pool);
    Client dbClient3 = check new (host, user, password, poolDB_1, port,
        {connectTimeout: 2, socketTimeout: 10}, pool);
    Client dbClient4 = check new (host, user, password, poolDB_1, port,
        {connectTimeout: 1}, pool);
    Client dbClient5 = check new (host, user, password, poolDB_1, port,
        {connectTimeout: 1}, pool);
    Client dbClient6 = check new (host, user, password, poolDB_1, port,
        {connectTimeout: 1}, pool);
...
function testLocalSharedConnectionPoolConfigMultipleDestinations() returns error? {
    ...
    Client dbClient2 = check new (host, user, password, poolDB_1, port, options, pool);
    Client dbClient3 = check new (host, user, password, poolDB_1, port, options, pool);
    Client dbClient4 = check new (host, user, password, poolDB_2, port, options, pool);
    Client dbClient5 = check new (host, user, password, poolDB_2, port, options, pool);
    Client dbClient6 = check new (host, user, password, poolDB_2, port, options, pool);
...
function testShutDownUnsharedLocalConnectionPool() returns error? {
    sql:ConnectionPool pool = {maxOpenConnections: 2};
    Client dbClient = check new (host, user, password, poolDB_1, port, options, pool);
...
function testStopClientUsingGlobalPool() returns error? {
    ...
    Client dbClient = check new (host, user, password, poolDB_1, port, options);
...
function testGlobalConnectionPoolConcurrentHelper1(string database) returns
    [stream<Result, error?>, stream<Result, error?>]|error {
...
function testGlobalConnectionPoolConcurrentHelper2(string database) returns (int|error)[]|error {
    Client dbClient = check new (host, user, password, database, port, options);
    (int|error)[] returnArray = [];
    stream<Result, error?> dt1 = dbClient->query(`select count(*) as val from Customers where registrationID = 1`);
    stream<Result, error?> dt2 = dbClient->query(`select count(*) as val from Customers where registrationID = 2`);
...
function drainGlobalPool(string database) returns error? {
    Client dbClient1 = check new (host, user, password, database, port, options);
    Client dbClient2 = check new (host, user, password, database, port, options);
    Client dbClient3 = check new (host, user, password, database, port, options);
    Client dbClient4 = check new (host, user, password, database, port, options);
    Client dbClient5 = check new (host, user, password, database, port, options);
